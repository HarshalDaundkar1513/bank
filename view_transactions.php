...
// Execute the query to fetch the last 20 transactions
$result = $conn->query("SELECT * FROM transactions ORDER BY timestamp DESC LIMIT 20");
...
<head>
    ...
    <title>The Spark Digital  - View Transactions</title>
...
<section class="text-gray-400 bg-gray-900 body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-10">
            <h1 class="sm:text-4xl text-3xl font-medium title-font mb-0 text-slate-200 hover:text-gray-200 hover:underline">View All Transactions</h1>
        </div>
